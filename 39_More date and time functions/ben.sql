...
SELECT DAYNAME('2007-07-14'); # The day is Saturday

SELECT upload_date, DAYNAME(upload_date) # gets day for each upload date
FROM tutorial;

SELECT NOW(); # displays current date and time

SELECT MAKEDATE(2003, 231); #Returns date of 231 day of 2003
