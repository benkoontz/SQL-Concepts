...
SELECT COUNT(*) FROM employee; # counts all records from employee

SELECT COUNT(*) FROM employee # counts all records from employee
WHERE age > 20; # counts number of employees < 20

#MAX function
SELECT MAX(age) FROM employee; # gets age of oldest employee
#MIN function
SELECT MIN(age) FROM employee; # gets age of oldest employee

SELECT SUM(salary) # sums all salaries
FROM employee;

SELECT AVG(age) FROM employee; # average age of all employees
