...
# round() function
select round(54.783, 1); # rounds to 54.8
select round(54.783, 2); # rounds to 54.78
select round(-12.57, 0); # rounds to -13

# gets average likes for each subject
select t.subject, ROUND(AVG(ti.likes))
AS 'The average number of likes round off the the nearest decimeal point'
FROM tutorial AS t
