...
# upper changes the case of all characters in a string to uppercase
SELECT UPPER('hey there');
# lower change the case of all characters to lower
SELECT LOWER('HEy there');

SELECT UPPER(title) FROM tutorial; # makes all tutorial titles uppercase
SELECT LOWER(title) FROM tutorial; # makes all tutorial titles lowercase
