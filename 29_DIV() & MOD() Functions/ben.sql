...
# DIV() & MOD() functions
# DIV performs digit division on numbers
SELECT 5 DIV 2; # outputs 2
# MOD gets the remainder
SELECT 5 MOD 2; # outputs 1

SELECT duration FROM tutorial;

SELECT title, duration DIV 1 AS minutes, # gives the whole number minute value
ROUND(duration*60 MOD 60) AS seconds # makes seconds between 0 and 60
FROM tutorial;
