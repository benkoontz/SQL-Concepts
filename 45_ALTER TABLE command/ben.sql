...
# works with the structure instead of the data

ALTER TABLE employee ADD city CHAR(20); # add the city field

SELECT * FROM employee;

ALTER TABLE employee DROP city; # drops the city field
