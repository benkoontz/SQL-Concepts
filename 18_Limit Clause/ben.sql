...
# what are the top and limit clauses?
# the top clause is used to fetch the top N number of records through
# a query from a table
# not all database support the top clause
# oracle supports rownum while MySQL uses limit

select * 
from employee;

select * # returns top 5 rows
from employee
limit 5;
