...
# example: sort data alphabetically
...
select * 
from employee
order by name; # sorts names alphabetically

select *
from employee 
order by name desc; # sorts names reverse alphabetically

select *
from employee 
order by age; # sorts age from smallest to largest
